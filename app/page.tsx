...
export default async function Home() {
  ...
  const modules = [
    ...
    { key: "business" as const, href: "/business", badge: "RADAR", title: "Local client finder", text: "Terminal world map, Google Places search, lead scoring, notes, and outreach status." },
    ...
    { key: "dev" as const, href: "/dev", badge: "DEV", title: "Mobile coding workspace", text: "File explorer, editor, terminal command buttons, build log helper, and project ZIP export." },
    { key: "chat" as const, href: "/chat", badge: "CHAT", title: "Private chat", text: "Two accounts, online lamps, terminal notifications, and media uploads stored in Neon." },
  ];
  ...
  return (
    <div className="stack">
      <section className="panel stack hero-grid">
        <div className="stack">
          ...
          <p className="muted">
            ...
            local business radar, email outreach, and the phone coding workspace.
          </p>
          <div className="row">
            <Link className="buttonlike" href="/business">open client radar</Link>
            <Link className="buttonlike" href="/dev">open dev workspace</Link>
      ...
      <section className="grid">
        {modules.filter((item) => canAccess(session, item.key)).map((item) => (
